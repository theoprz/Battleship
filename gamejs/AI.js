let battleship = require('./battleship.js');
...
function AI(game) {
	...
	this.guessCoordinates = function() {
		let array = this.possibleCoordinatesArray;
		let subArray = this.possibleCoordinatesSubArray;
		...
		//If the possibleCoordinatesArray is not empty
			...
			let coordinates = subArray[Math.floor(Math.random() * subArray.length)];
